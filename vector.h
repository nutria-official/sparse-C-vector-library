...
search* indexCheck(vector *x, const size_t INDEX); // Checks if an index is occupied.
bool reallocationCheck(vector *x, const size_t RESIZE_SIZE, const size_t RESIZE_AMOUNT); // Checks if a given vector should be resized or not.
